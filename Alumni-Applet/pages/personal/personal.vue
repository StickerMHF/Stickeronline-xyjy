				...
				<view class="box">
					...
					<view class="box-bd">
						<navigator url="/pages/personal/myNews/myNews/myNews">
							<view class="item">
								<view class="icon"><img src="http://www.imapway.cn/Alumni/static/personal/wdpl2x.png" /></view>
								<view class="text">我的消息</view>
							</view>
						</navigator>
						<navigator url="/pages/personal/myApply/myApply/myApply">
							<view class="item">
								<view class="icon"><img src="http://www.imapway.cn/Alumni/static/personal/apply2x.png" /></view>
