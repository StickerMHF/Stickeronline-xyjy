<template>
  <view class="teachers-detail">
    ...
    <view v-if="tabCur === '0'" class="td-item td-grgk">
      ...
      <view
        class="td-item-content"
        style="padding: 0 20px; background: #ffffff"
        v-html="content.grjj"
      >
      </view>
    </view>
    ...
    <view v-if="tabCur === '2'" class="td-item td-kjcg">
      ...
      <view style="width: 80%; margin: 0 auto" v-html="content.kjcg"> </view>
      ...
      <view style="width: 80%; margin: 0 auto" v-html="content.ryjl"> </view>
    </view>
  </view>
</template>

<script>
import { getTeachersById } from "@/api/teachers.js";
export default {
  data() {
    return {
      tabCur: "0",
      ...
      getTeachersById(param).then(data => {
        ...
        if (res && res.data.success) {
          ...
          for (let i in dataObj) {
            if (dataObj[i] === null || dataObj[i] === "null") {
              dataObj[i] = "";
            }
          }
          this.content = dataObj;
        }
      });
    },
    tabSelect(e) {
