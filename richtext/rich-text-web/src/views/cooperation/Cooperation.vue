<template>
  <a-card :bordered="false" style="height: calc( 100% - 20px)">
    ...
    <div class="table-operator" style="border-top: 5px">
      <a-button @click="handleAdd" type="primary" icon="plus">校友合作</a-button>
    ...
    <!-- 用户Model -->
    <cooperationModel ref="modalForm" @close="loadData()"></cooperationModel>
...
<script>
  ...
  import cooperationModel from './CooperationModel.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        queryParam: {},
        url: {
          list: "stickeronline/cooperation/list",
          delete:'stickeronline/cooperation/delete',
          deleteBatch:'stickeronline/cooperation/deleteBatch'
        },
        columns: [
          {ellipsis: true,title: '合作事项',align: "center",dataIndex: 'title',width: 120},
          {ellipsis: true,title: '联系电话',align: "center",width: 100,dataIndex: 'contact'},
          {ellipsis: true,title: '合作内容',align: "center",width: 180,dataIndex: 'contents'},
