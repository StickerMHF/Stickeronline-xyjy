...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: 'stickeronline/sys/dictItem/list',
        delete: 'stickeronline/sys/dictItem/delete',
        deleteBatch: 'stickeronline/sys/dictItem/deleteBatch'
      }
    }
  },
  created() {
  ...
  methods: {
    ...
    edit(record) {
      ...
      this.visible = true
      this.$nextTick(() => {
        this.form.setFieldsValue(this.model, 'itemText', 'itemValue')
      })
