<template>
  <a-card :bordered="false" style="height: calc( 100% - 20px)">
    ...
    <div class="table-operator" style="border-top: 5px">
      <a-button @click="handleAdd" type="primary" icon="plus">新增校友会</a-button>
      ...
      <a-table
        ...
        <template slot="type" slot-scope="text, record, index">
          <div class="anty-img-wrap">
            <span v-if="record.type=='3'">同城校友会</span>
            <span v-else-if="record.type=='4'">行业校友会</span>
            <span v-else>校友之窗</span>
          </div>
        </template>
    ...
    <!-- 用户Model -->
    <alumnusModel ref="modalForm" @close="loadData()"></alumnusModel>
...
<script>
  ...
  import alumnusModel from './AlumnusModel.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        queryParam: {},
        url: {
          list: "stickeronline/alumnus/list",
          delete:'stickeronline/alumnus/delete',
          deleteBatch:'stickeronline/alumnus/deleteBatch'
        },
        columns: [
          {ellipsis: true,title: '校友会名称',align: "center",dataIndex: 'name',width: 120},
          {ellipsis: true,title: '发布时间',align: "center",width: 180,dataIndex: 'createTime'},
          {ellipsis: true,title: '分类',align: "center",width: 180,dataIndex: 'type',scopedSlots: {customRender: 'type'}},
          {ellipsis: true,title: '活跃度',align: "center",width: 180,dataIndex: 'liveness'},
          {ellipsis: true,title: '成员数量',align: "center",width: 100,dataIndex: 'member'},
