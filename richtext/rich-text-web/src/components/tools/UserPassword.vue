    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="用户名">
          <a-input type="text" disabled placeholder="请输入旧密码" v-decorator="[ 'username', validatorRules.username]" />
        </a-form-item>
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="原密码">
          <a-input type="password" placeholder="请输入新密码" v-decorator="[ 'oldPassword', validatorRules.oldPassword]" />
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: "/stickeronline/sys/user/changPassword",
        username:"",
      }
    },
    methods: {
