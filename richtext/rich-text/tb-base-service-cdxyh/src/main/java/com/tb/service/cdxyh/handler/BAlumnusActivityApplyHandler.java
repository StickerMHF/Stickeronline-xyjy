...
@RouteHandler("stickeronline/alumnusActivity/apply")
@Api(tags = "组织")
public class BAlumnusActivityApplyHandler {
    private BAlumnusActivityApplyService bAlumnusActivityApplyService =
            AsyncServiceUtil.getAsyncServiceInstance(BAlumnusActivityApplyService.class);
    ...
    public Handler<RoutingContext> add() {
        return ctx -> {
            bAlumnusActivityApplyService.add(CommonUtil.createCondition(ctx.request(), ctx.getBody()), res -> {
                if (res.succeeded()) {
    ...
    public Handler<RoutingContext> queryPageList() {
        return ctx -> {
            bAlumnusActivityApplyService.queryPageList(CommonUtil.createCondition(ctx.request(), ctx.getBody()), res -> {
                if (res.succeeded()) {
                    HttpUtil.fireJsonResponse(ctx.response(), HTTP_OK,
                            ReplyObj.build().setSuccess(true).setResult(res.result()).setMsg("succeed"));
                } else {
    ...
    public Handler<RoutingContext> queryById() {
        return ctx -> {
            bAlumnusActivityApplyService.queryById(CommonUtil.createCondition(ctx.request(), ctx.getBody()), res -> {
                if (res.succeeded()) {
                    HttpUtil.fireJsonResponse(ctx.response(), HTTP_OK,
                            ReplyObj.build().setSuccess(true).setResult(res.result()).setMsg("succeed"));
                } else {
    ...
    public Handler<RoutingContext> edit() {
        return ctx -> {
            bAlumnusActivityApplyService.edit(CommonUtil.createCondition(ctx.request(), ctx.getBody()), res -> {
                if (res.succeeded()) {
                    HttpUtil.fireJsonResponse(ctx.response(), HTTP_OK,
                            ReplyObj.build().setSuccess(true).setResult(res.result()).setMsg("succeed"));
                } else {
    ...
    public Handler<RoutingContext> delete() {
        return ctx -> {
            bAlumnusActivityApplyService.delete(CommonUtil.createCondition(ctx.request(), ctx.getBody()), res -> {
                if (res.succeeded()) {
                    HttpUtil.fireJsonResponse(ctx.response(), HTTP_OK,
                            ReplyObj.build().setSuccess(true).setResult(res.result()).setMsg("succeed"));
                } else {
